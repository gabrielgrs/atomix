...
export default (props) => {
  return (
    <div>
      <Navbar
        brand="Atomix"
        icon="https://static1.squarespace.com/static/54e4ede1e4b012fa4a38638c/t/5b96a82a0e2e72baf585cc78/1536600122199/Atom.png"
      >
        <NavItem
      ...
      <div className="container">
        ...
        <Button
          style="primary"
          onClick={() => alert('Botão acionado com sucesso')}
          text="Teste"
        />
        <Button
          style="primary"
        ...
        <div>
          <Textarea type="text" placeholder="Placeholder" value="Value" />
        </div>
        ...
        <Table
          headers={['FirstName', 'Second Name', 'Third Name', 'Random', 'Food']}
        >
      ...
      <Footer
        ...
        secondContent={`
            ...
            `}
      >
        <FooterBottom content="Footer content" />
      </Footer>
    </div>
  )
}
